...
/* package simple-library-0.1.0.0 */
#define VERSION_simple_library "0.1.0.0"
#define MIN_VERSION_simple_library(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "simple-library-0.1.0.0-56DTLUxLonE9scpi1RguOr"

#define CURRENT_PACKAGE_KEY "simple-library-0.1.0.0-56DTLUxLonE9scpi1RguOr"
